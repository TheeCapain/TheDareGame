            ...
            <div>
                ...
                {players.map(player => (
                    <li type="text" key={player.playerId} className="flex flex-row w-full">
                        ...
                        <label onClick={changeTeam(player.playerId, player.playerTeam)} className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
